...
def main():
    sp = SpacyTokenizer(annotators=set(['ner']))
    tok = sp.tokenize('Aramais Yepiskoposyan played for FC Ararat Yerevan, an Armenian football club based in Yerevan during 1986 to 1991.')
    print(tok.entity_groups())
