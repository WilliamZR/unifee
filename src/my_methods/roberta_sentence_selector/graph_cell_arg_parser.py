...
def get_parser():
    ...
    parser.add_argument("--data_dir", default="/home/hunan/feverous/mycode/data/", type=str,
                        help="The input data dir. ", )
    parser.add_argument("--cache_dir", default="/home/hunan/feverous/mycode/cached_data/", type=str,
                        help="cached data dir. ", )

    parser.add_argument("--ckpt_root_dir", default="/home/hunan/feverous/mycode/checkpoints", type=str,
    ...
    parser.add_argument("--model_type", default="TapasGnn", type=str,
                        help="Name of model.", )
    parser.add_argument("--bert_name", default="/home/hunan/bert_weights/tapas-large-finetuned-tabfact", type=str,
                        help="name or path of pretrained bert.")
    parser.add_argument("--data_generator", default="TapasGnnGenerator", type=str,
