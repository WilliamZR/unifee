...
def model_trainer(model_path, train_dataset, test_dataset=None):
    model = RobertaForSequenceClassification.from_pretrained(
        '/home/hunan/bert_weights/roberta-large-snli_mnli_fever_anli_R1_R2_R3-nli', num_labels =3, return_dict=True)
...
def claim_evidence_predictor(annotations_train, annotations_dev, args):
    ...
    tokenizer = RobertaTokenizer.from_pretrained(
        '/home/hunan/bert_weights/roberta-large-snli_mnli_fever_anli_R1_R2_R3-nli', model_max_length=512)
